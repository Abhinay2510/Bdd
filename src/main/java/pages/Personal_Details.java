...
public class Personal_Details extends OnlineActions {
...
//===========================================Methods==================================================//
	...
	public void PersonalDetails() throws IOException, InterruptedException 
	{
		...
		//SoftVerifyTextOnly(status, "Details Saved Successfully", "pass");
		
		SoftVerifyTextOnly(status, getMapData.get("Uidata"), "pass");
